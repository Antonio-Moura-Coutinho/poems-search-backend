...
poems_final['font'] = 'poetry_foundation'
poems_final = pd.concat([poems_final, poems_english])
...
#poems2 = pd.read_csv("original_datasets/PoetryFoundationData.csv", encoding='utf-8', delimiter=',', engine='python', skipinitialspace=True)
poems_english = pd.read_csv("original_datasets/poetry.csv", encoding='utf-8', delimiter=',', engine='python', skipinitialspace=True)
